...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Estimate - Pelican Roofing | Louisiana Hail Resistant Asphalt Shingles Claims Services</title>
        <meta name="description" content="Estimate Page for Pelican Roofing.">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta property="og:title" content="Estimate - Pelican Roofing | Louisiana Hail Resistant Asphalt Shingles Claims Services" />
        <meta property="og:description" content="Estimate Page for Pelican Roofing." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.pelicanroofinggroup.com/estimate.aspx" />
    ...
    <body class="index-page">
                ...
                <div class="z-content">
                    <div class="z-container">
                        <div class="z-col-eight">
                            ...
                            <h4>If you would like to schedule a FREE estimate, please fill out the form below.</h4>
        ...
        <script>
            $(document).ready(function(){
                $('li.z-estimate-link > a').css({'color':'#fef301'});            
